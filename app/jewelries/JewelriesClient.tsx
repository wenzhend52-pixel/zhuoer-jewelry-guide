...
export function JewelriesClient() {
  const searchParams = useSearchParams();
  const selectedElement = searchParams.get("element") as ElementKey | null;
  const filteredJewelries = selectedElement ? jewelries.filter((jewelry) => jewelry.element === selectedElement) : jewelries;
