...
export function ResultClient() {
  ...
  const input: BirthInput = {
    ...
    isBirthTimeUnknown: searchParams.get("timeUnknown") === "true",
    calendarType: (searchParams.get("calendarType") as CalendarType) || "solar",
    gender: (searchParams.get("gender") as Gender) || "unspecified",
